...
def load_text_encoder_state_dicts(state_dicts=[], embedding_directory=None, clip_type=CLIPType.STABLE_DIFFUSION, model_options={}):
    ...
    if len(clip_data) == 1:
        ...
        elif clip_type == CLIPType.FLUXC:
            clip_target.clip = comfy.text_encoders.flux.flux_clipcustom(**t5xxl_detect(clip_data))
            clip_target.tokenizer = comfy.text_encoders.flux.FluxTokenizer
        elif clip_type == CLIPType.FLUXMOD:
            clip_target.clip = comfy.text_encoders.flux.flux_clipmod(**t5xxl_detect(clip_data))
            clip_target.tokenizer = comfy.text_encoders.flux.FluxTokenizer
