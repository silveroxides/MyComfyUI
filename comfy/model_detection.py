...
def detect_unet_config(state_dict, key_prefix, metadata=None):
    ...
    if '{}distilled_guidance_layer.proj_in.weight'.format(key_prefix) in state_dict_keys: #FluxMod
        dit_config = {}
        dit_config["image_model"] = "fluxmod"
        ...
        dit_config["qkv_bias"] = True
        dit_config["approximator_in_dim"] = 64
        dit_config["approximator_depth"] = 5
        dit_config["approximator_hidden_size"] = 5120
        return dit_config
    ...
    if '{}t_block.1.weight'.format(key_prefix) in state_dict_keys: # PixArt
        ...
        if pe_key in state_dict_keys:
            ...
            if state_dict[pe_key].shape[1] == 4096:
                dit_config["pe_interpolation"] = 2
            else:
                dit_config["pe_interpolation"] = 4
