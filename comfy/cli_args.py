...
class LatentPreviewFormat(enum.Enum):
    JPEG = "JPEG"
    PNG = "PNG"
    WEBP = "WEBP"

parser.add_argument("--preview-format", type=LatentPreviewFormat, default=LatentPreviewFormat.JPEG, help="Default preview format for sampler nodes.", action=EnumAction)
