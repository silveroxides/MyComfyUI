...
class FluxMod(supported_models_base.BASE):
    unet_config = {
        "image_model": "fluxmod",
        "guidance_embed": True,
    }
    ...
    def get_model(self, state_dict, prefix="", device=None):
        out = model_base.FluxMod(self, model_type=model_base.ModelType.FLUX, device=device)
        return out

class FluxModChroma(FluxMod):
    unet_config = {
        "image_model": "fluxmod",
        "guidance_embed": False,
    }
...
models = [Stable_Zero123, SD15_instructpix2pix, SD15, SD20, SD21UnclipL, SD21UnclipH, SDXL_instructpix2pix, SDXLRefiner, SDXL, SSD1B, KOALA_700M, KOALA_1B, Segmind_Vega, SD_X4Upscaler, Stable_Cascade_C, Stable_Cascade_B, SV3D_u, SV3D_p, SD3, StableAudio, AuraFlow, PixArtAlpha, PixArtSigma, HunyuanDiT, HunyuanDiT1, FluxInpaint, Flux, FluxSchnell, GenmoMochi, LTXV, HunyuanVideoSkyreelsI2V, HunyuanVideoI2V, HunyuanVideo, CosmosT2V, CosmosI2V, Lumina2, WAN21_T2V, WAN21_I2V, FluxMod, FluxModChroma]
